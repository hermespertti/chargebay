...
console.log('carPos:', await S('JSON.stringify(window.__GAME.carPos(0))'));
// true side profile at wheel height
await S("(()=>{const g=window.__GAME;const p=g.carPos(0);g.pose(p.x, 0.45, p.z+4.8, 0, 0); g.lookAt(p.x, 0.45, p.z, 4.8);})()");
await new Promise(r=>setTimeout(r,2400));
await pg.screenshot({path:'progress/artifacts/orig_profile.png'});
